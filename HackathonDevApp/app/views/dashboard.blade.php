                      ...
                      @foreach($events as $event)
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="{{ $event->image }}" alt="" class="img-responsive" style="height:300px;">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                                            <a href="{{ URL::to('view-event/'.$event->id) }}" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> View Event</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="content" style="height:150px;">
                                    <h4><a href="{{ URL::to('view-event/'.$event->id) }}">{{ $event->title }}</a></h4>
                                    <p class="author-category">Start Date: {{ $event->from_date }}
                                    </p>
                                    <p class="author-category">End Date: {{ $event->to_date }}
                                    </p>
                                    
                                </div>
                                <p class="read-more"><a href="{{ URL::to('view-event/'.$event->id) }}" class="btn btn-template-main">View Event Details</a>
                                    </p>
                            </div>
                            <!-- /.box-image-text -->
                        ...
                        @endforeach
                        <p>Number of Events: {{ $event_count }}</p>
