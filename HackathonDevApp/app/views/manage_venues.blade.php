  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {{ Form::open(array('url'=>'add-venue','files'=>true)) }}

                <div class="col-md-12">
                    <big><b><span class="fa fa-map-marker"></span>&nbsp;&nbsp;Venue</b></big>
                </div>
                ...
                {{ Form::label('Address') }}
                <br>
                {{ Form::textarea('address',null,array('class'=>'form-control','placeholder'=>'Enter address here...')) }}
                </div>
              ...
              <div class="col-md-12">
                {{ Form::submit('Add Venue',array('class'=>'form-control btn btn-default')) }}
              </div>
...
<div class="container">
  ...
  <button class="btn btn-default" data-toggle="modal" data-target="#myModal">Add Venue</button>
  ...
  <tr>
  <td><small><small>{{ $venue->title }}</small></small></td>
  <td><small><small>{{ $venue->address }}</small></small></td>
  <td>
    <a href="{{ URL::to('view-venue/'.$venue->id) }}" style="text-decoration:none;">
    <input type='button' class='btn btn-xs btn-default' value="View">
    </a>

    <a href="{{ URL::to('edit-venue/'.$venue->id) }}" style="text-decoration:none;">
    <input type='button' class='btn btn-xs btn-default' value="Edit">
    </a>

    <a href="{{ URL::to('delete-venue/'.$venue->id) }}" style="text-decoration:none;">
